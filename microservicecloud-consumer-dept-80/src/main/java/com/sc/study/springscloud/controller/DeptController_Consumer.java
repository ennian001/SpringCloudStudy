package com.sc.study.springscloud.controller;
...
//    private static final String REST_URL_PRE = "http://localhost:8001";
    private static final String REST_URL_PRE = "http://MICROSERVICECLOUD-DEPT";
    @Autowired
    ...
    {
        List forObject = restTemplate.getForObject(REST_URL_PRE + "/dept/list", List.class);
        return forObject;
    }
